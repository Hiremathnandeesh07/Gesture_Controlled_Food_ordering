...
class FoodOrderingApp:
    ...
    def create_cart(self):
        ...
        self.checkout_button = ttk.Button(self.cart_frame, text="Checkout", command=self.confirm_checkout,
                                          style='Custom.TButton')
    ...
    def confirm_checkout(self):
        ...
        confirmation_message = f"Proceed to checkout with total amount: ${total:.2f}?"
        ConfirmationDialog(self.root, confirmation_message, self.finalize_order)
                ...
                for id, landmark in enumerate(landmarks):
                    ...
                    class ConfirmationDialog:
                        def __init__(self, parent, message, callback):
                            ...
                            self.top.geometry("300x150+400+300")  # Centered on the screen

                            Label(self.top, text=message, padx=20, pady=20).pack()
